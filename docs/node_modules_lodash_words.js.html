...
<head>
  ...
  <title>Devo Applications Builder node_modules/lodash/words.js</title>
...
<div class="top-nav">
        ...
        <div class="core" id="main-content-wrapper">
            <div class="content">
                <header class="page-title">
                    <p>Source</p>
                    <h1>node_modules/lodash/words.js</h1>
                </header>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>var asciiWords = require('./_asciiWords'),
